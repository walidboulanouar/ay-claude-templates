...
export interface PackageTemplate {
  ...
  variables?: string[]; // Variables to replace (e.g., {{name}}, {{author}})
}
 ...
 * Get template by ID
 */
export function getTemplate(templateId: string): PackageTemplate | undefined {
 ...
 * List all templates
 */
export function listTemplates(contentType?: string): PackageTemplate[] {
  if (contentType) {
