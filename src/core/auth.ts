...
export class SecureTokenStorage {
   ...
   */
  static async storeToken(token: CLIToken): Promise<void> {
    try {
   ...
   */
  static async getToken(): Promise<CLIToken | null> {
    try {
...
export class CLIAuthentication {
   ...
   */
  private async fetchUserInfo(accessToken: string): Promise<{ id: string; email: string }> {
   ...
   */
  async refreshToken(refreshToken: string): Promise<CLIToken> {
    try {
   ...
   */
  async getAuthenticatedToken(): Promise<CLIToken | null> {
