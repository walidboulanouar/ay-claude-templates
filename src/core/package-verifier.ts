...
export class PackageVerifier {
   ...
   */
  static async validateStructure(packageDir: string, contentType: string): Promise<PackageVerification> {
    const errors: string[] = [];
   ...
   */
  static async scanForMaliciousContent(packageDir: string): Promise<PackageVerification> {
    const errors: string[] = [];
