 ...
 * Workspace command
 */
export async function workspaceCommand(action, workspaceId, options = {}) {
 ...
 * Template command
 */
export async function templateCommand(action, templateId, options = {}) {
    if (options.list || action === 'list') {
    ...
    if (options.create || action === 'create') {
        ...
        try {
            await createFromTemplate(template.id, answers.packageName, {
...
//# sourceMappingURL=workspace-features.js.map